...
namespace AdvancedEditorTools {
    ...
    public class AETMonobehaviourCustomEditor : UnityEditor.Editor {
                            ...
                            case ColumnInfo columnInfo:
                                ...
                                switch (columnInfo)
                                {
                                    case BeginColumnAreaInfo beginColumnAreaInfo:
                                        ...
                                        EditorGUILayout.BeginVertical(GetContainerStyle(columnStyles.Peek(),
                                    ...
                                    case NewColumnInfo newColumnInfo:
                                        ...
                                        EditorGUILayout.BeginVertical(GetContainerStyle(columnStyle,
